...
nb_model_white <- naiveBayes(as.factor(label) ~ . , traindata_white_full, laplace=.01)
...
nb_model_red <- naiveBayes(as.factor(label) ~ . , traindata_red_full, laplace=.01)
...
traindata_full <- data_red_wine_labelled[indxTrain_red_full, !(names(data_red_wine_labelled) %in% c('quality'))]
testdata_full <- data_red_wine_labelled[-indxTrain_red_full, !(names(data_red_wine_labelled) %in% c('quality'))]
